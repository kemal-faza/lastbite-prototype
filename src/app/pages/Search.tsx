...
const TRENDING_SEARCHES = ['Sushi', 'Nasi Goreng', 'Smoothie', 'Tiramisu', 'Buah Segar'];
      ...
      <div className="p-4 flex-1">
        {!query ? (
            ...
            {recentSearches.length > 0 && (
              <section>
                <div className="flex items-center justify-between mb-3">
                  <h2 className="text-sm font-semibold text-gray-900">Pencarian Terakhir</h2>
                  <button 
          ...
          <div className="text-center py-12 mt-10">
            ...
            <h3 className="text-base font-medium text-gray-900 mb-1">Mencari "{query}"</h3>
            <p className="text-sm text-gray-500">Tekan enter untuk melihat hasil pencarian lengkap</p>
          </div>
        )}
      </div>
    </div>
